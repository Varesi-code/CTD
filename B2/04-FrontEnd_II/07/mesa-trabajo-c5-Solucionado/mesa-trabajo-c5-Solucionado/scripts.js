...
//recorrer y sumar otra vez
// items.forEach((item) => {contenedor.appendChild(item)});

//recorrer y sumar con variables
items.forEach((item) => {
...
//templateVars.forEach((animal) => {
// const templateString = `  <div class="item">
//   <img src="${animal.imgUrl}">
//   <h2>${animal.title}</h2>
//   <p>${animal.description}</p>
//   </div>`;
// contenedor.innerHTML += templateString;
//});